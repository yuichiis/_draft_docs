...
class Buffer
{
    ...
    protected BufferInterface $host_buffer; // Buffer for FFI
    ...
    public function read(
        ...
        BufferInterface $host_buffer,        // Interop\Polite\Math\Matrix\LinearBuffer
        int $size=null,
        int $offset=null,
        int $host_offset=null,
    ...
    public function fill(
        CommandQueue $command_queue,
        BufferInterface $pattern_buffer,  // Interop\Polite\Math\Matrix\LinearBuffer
        int $size=null,
        int $offset=null,
